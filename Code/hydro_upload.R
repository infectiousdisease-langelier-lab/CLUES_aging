# Here I analyze the CLUES bulk data, controlling for hydro
...
meta_complete <- read_csv("hydro_meta.csv")
...
cleaned_metadata$PlaquenilNow <- as.factor(cleaned_metadata$PlaquenilNow)
...
## Make design matrix, controlling for ethnicity, sex, BMI
design <- model.matrix(~Age + female + RaceEth + PlaquenilNow,
